...
import avatar from "assets/img/avatars/avatar5.JPG";
...
const Navbar = (props) => {
  ...
  return (
    ...
    >
      ...
      <span
        className="ml-[160px] flex cursor-pointer text-xl text-gray-600 dark:text-white xl:hidden"
      ...
      <div style={{ display: "flex" }}>
        {!isMobile ? (
          <>
            ...
            <a href="https://Karan Limbachiya--portfolio.vercel.app/" className="navItem">About</a>
          </>
        ) : null}
